        ...
        <div className="min-h-screen bg-gray-100">
            <div className="max-w-4xl  bg-white  overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold text-indigo-600">Professional Summary</h2>
                        <p className="mt-2">
                            {bio}
                        </p>
                    </section>
                    <section className="mb-8">
                        ...
                        <div className="flex flex-wrap mt-2">
                            {skills.map((skill) => (
                                <div key={skill.id} className="bg-gray-200 text-gray-800 px-2 py-1 rounded-full mr-2 mb-2">
                                    {skill.name}
                                </div>
                            ))}
                        </div>
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold text-indigo-600">Work Experience</h2>
                        {experience.map((exp) => (
                            <div key={exp.id} className="mt-4">
                                <h3 className="text-xl font-semibold">{exp.job_title} at {exp.company_name}</h3>
                                <p className="text-gray-600">{exp.start_date} - {exp.end_date}</p>
