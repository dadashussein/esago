  ...
  return (
    <div className="bg-white text-gray-800 font-sans antialiased py-8 max-w-2xl mx-auto">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-bold text-purple-600 border-b-2 border-gray-300 mb-4">
          SUMMARY
        </h2>
      ...
      <section>
        ...
        <ul className="list-disc list-inside text-base">
          <li>
            Technical Skills: Project Management, Structural Analysis, Robotics
            and Automation, CAD
          </li>
          <li>Languages: English, Malay, German</li>
          <li>
            Certifications: Professional Engineer (PE) License, Project
            Management Professional (PMP)
          </li>
          <li>
            Awards/Activities: Received the "Engineering Excellence" Award for
            outstanding contributions to project innovation, Borcelle
            Technologies
          </li>
        </ul>
      </section>
