    ...
    <div style={{ fontSize: `${safeTextSize}px` }} className=" h-[70.2rem]">
      <div className="flex w-full   text-stone-700 pb-8">
        ...
        <div className="basis-2/6 pt-8 pl-10 pr-1">
          ...
          >
            <img className="max-w-full borderw-full" src={img} alt="" />
          </div>
          {/* leftbar-body */}
            ...
            {education.length > 0 && (
              <div className="mt-14">
                <h3
                  ...
                  className="tracking-wide font-medium uppercase text-base mb-2 pb-2 leading-none border-b border-stone-400"
                >
        ...
        <div className="pt-8 w-4/6 ">
          ...
          <div className="pl-8 pr-10">
            {bio && (
              <div className="mb-2 break-words text-wrap max-w-[24rem]">
                <h3
                  style={{ fontSize: `${headerSize}px` }}
                  className="uppercase font-medium text-base tracking-wide leading-none pb-1.5 mb-2 border-b border-stone-400"
                >
                  Summary
                </h3>
                ...
                {experience.map((exp, index) => (
                  <div className="mb-2" key={index}>
                    ...
                    <div className="flex align-end mb-3 italic">
                      <span className="pr-2 border-r border-stone-400 mr-2 leading-none ">
                        {exp.company_name}
                      </span>
                      <div className="pr-2 mr-2 leading-none ">
