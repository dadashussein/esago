import compSvg from '../assets/svgs/404-computer.svg';
        ...
        <div><section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center">
                    ...
                    <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Sorry, we can&rsquo;t find that page. You&apos;ll find lots to explore on the home page. </p>
